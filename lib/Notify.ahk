...
Notify(Title="!!!",Message="",Duration=30,Options="",Image="")
{
 ...
 static GC := "ffFFff" ;   [BEEAFC&373737] Gui Color         ;   ie: don't use GF<=Gui#<=GL
 static GR := 0        ;    Gui Radius   [12]     ;       elsewhere in your script
 static GT := "Off"    ;    Gui Transparency [0ff]
 static TS := 10        ;  [8] Title Font Size
 static TW := 625      ;  Title Font Weight 
 static TC := "Black"  ;  Title Font Color [White]
 static TF := "Arial Black"  ;  Title Font Face [Arial]
 static MS := 10        ; [10]Message Font Size
 static MW := 550      ;Message Font Weight
 static MC := "Black"  ;Message Font Color [White]
 static MF := "Arial"  ;Message Font Face
 static BC := "030303"  ; Border Colors
 static BW := 1        ; Border Width/Thickness
 static BR := 0       ; Border Radius [13]
 static BT := 105      ; Border Transpacency
 static BF := 150      ; Border Flash Speed
 static SI := 150      ;  Speed In (AnimateWindow) [350]
 static SC := 100      ;  Speed Clicked (AnimateWindow)
 static ST := 150      ;  Speed TimeOut (AnimateWindow) [450]
 static IW := 32       ;  Image Width [32]
